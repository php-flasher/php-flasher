    ...
    <div class="text-center">
      <div class="flex justify-center mb-8 animate-fade-in">
        <div class="relative inline-block">
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="240" height="40" viewBox="0 0 5082 781" preserveAspectRatio="xMidYMid meet" class="mx-auto">
...
/* Add the pulsing glow effect */
@keyframes glowPulse {
  0%, 100% { 
    filter: drop-shadow(0 0 2px rgba(64, 82, 181, 0.3));
  }
  50% { 
    filter: drop-shadow(0 0 8px rgba(64, 82, 181, 0.8));
  }
}
</style>
