...
final class NotyPluginTest extends TestCase
{
    ...
    {
        $this->assertSame('/vendor/flasher/flasher-noty.min.js', $this->notyPlugin->getScripts());
    }

    public function testGetStyles(): void
    {
        $this->assertSame('/vendor/flasher/flasher-noty.min.css', $this->notyPlugin->getStyles());
    }
    ...
    {
        $expected = [
            'scripts' => ['/vendor/flasher/flasher-noty.min.js'],
            'styles' => ['/vendor/flasher/flasher-noty.min.css'],
            'options' => [],
        ];
