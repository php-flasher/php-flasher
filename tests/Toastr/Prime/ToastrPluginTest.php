...
final class ToastrPluginTest extends TestCase
{
    ...
    {
        $this->assertSame('/vendor/flasher/flasher-toastr.min.js', $this->toastrPlugin->getScripts());
    }

    public function testGetStyles(): void
    {
        $this->assertSame('/vendor/flasher/flasher-toastr.min.css', $this->toastrPlugin->getStyles());
    }
    ...
    {
        $expected = [
            'scripts' => ['/vendor/flasher/flasher-toastr.min.js'],
            'styles' => ['/vendor/flasher/flasher-toastr.min.css'],
            'options' => [],
        ];
