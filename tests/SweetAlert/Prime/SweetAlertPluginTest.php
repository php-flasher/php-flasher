...
final class SweetAlertPluginTest extends TestCase
{
    ...
    {
        $this->assertSame('/vendor/flasher/flasher-sweetalert.min.js', $this->sweetAlertPlugin->getScripts());
    }

    public function testGetStyles(): void
    {
        $this->assertSame('/vendor/flasher/flasher-sweetalert.min.css', $this->sweetAlertPlugin->getStyles());
    }
    ...
    {
        $expected = [
            'scripts' => ['/vendor/flasher/flasher-sweetalert.min.js'],
            'styles' => ['/vendor/flasher/flasher-sweetalert.min.css'],
            'options' => [],
        ];
