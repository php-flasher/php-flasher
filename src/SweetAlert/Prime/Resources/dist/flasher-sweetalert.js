(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.sweetalert = factory(global.flasher));
	...
	class SweetAlertPlugin extends flasher.AbstractPlugin {
	    renderEnvelopes(envelopes) {
	        envelopes.forEach((envelope) => {
	            ...
	            (_a = this.sweetalert) === null || _a === void 0 ? void 0 : _a.fire(options).then(function (promise) {
	    ...
	    renderOptions(options) {
	        this.sweetalert =
	            this.sweetalert ||
	                Swal.mixin(Object.assign({ timer: (options.timer || 5000), timerProgressBar: (options.timerProgressBar || true) }, options));
...
//# sourceMappingURL=flasher-sweetalert.js.map
