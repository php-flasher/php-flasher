        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('public_path')
                    ->info('Prefix prepended to every flasher asset URL. Useful when the app is served from a subdirectory (e.g. "/Symfony") or a separate asset host (e.g. "https://cdn.example.com"). Defaults to "".')
                    ->defaultValue('')
                ->end()
