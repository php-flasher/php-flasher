...
final class CreatedAtStamp implements OrderableStampInterface, PresentableStampInterface, StampInterface
{
    ...
    {
        $this->createdAt = $createdAt ?: new \DateTimeImmutable('now', new \DateTimeZone('Africa/Casablanca'));
